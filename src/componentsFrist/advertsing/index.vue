...
@import "../../../static/css/mixin.styl"
   ...
   #_swiper1
      height 7rem
      .recommend_bottom
        .recommend_bottom_list_container
           overflow: hidden
           width 100%
           .recommend_bottom_list
             width 200%
             .recommend_bottom_item
              width 13.9%
.recommend
  width 100%
  .recommend_top
  ...
  .recommend_bottom
    ...
    .recommend_bottom_list
      ...
      .recommend_bottom_item
        ...
        align-items center
        flex-direction column
        .recommend_bottom_item_content
          background wheat
          img
            width 100%
            height 3rem
        .recommend_bottom_item_text
          span
            font-size 0.3rem
            float left
          .red_prise
